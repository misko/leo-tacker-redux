...
The ninth V5 online-analysis window (`288..323`) closed with exact digest
`12d340830c7d235bfd93980e78573b2c3221504f1509514a11530e196491be3e`.
The sealed Release-F slice exited zero after 9m34s with no parked work.
Independent dashboard reads proved 72 complete FeatureSet projections with
3,456 rows, 72 complete 16-tile/262,144-cell waterfalls, and 72 Starlink v0.2
views containing 24 clipped `not_evaluated` and 48 candidate recordings, 768
streams and 6,144 method outputs. Candidate views retain both
`whole-search-calibration-required` and `candidate-evidence-only`, and every
calibrated-detection count remains null. Capture advanced from 325 to 342
during analysis and to 346 during the audit, with 692/692 unique recordings,
maximum skew still 61,534,172 ns, and no halt.

The tenth V5 online-analysis window (`324..359`) closed with exact digest
`caaa36140a3a9406738faf2a379b19a65262866050c7d997207d4576e65f2d00`.
The sealed Release-F slice exited zero after 9m45s with no parked work.
Independent dashboard reads proved 72 complete FeatureSet projections with
3,456 rows, 72 complete 16-tile/262,144-cell waterfalls, and 72 Starlink v0.2
views containing 24 clipped `not_evaluated` and 48 candidate recordings, 768
...
Capture advanced from 361 to 379 during analysis and to 381 during the audit,
with 762/762 unique recordings and no halt.

The eleventh V5 online-analysis window (`360..395`) closed with exact digest
`745ffe0de077e9b0f2016ff24f3b6cc5fb77f2b368c7bbfea4b07c8f0ba62829`.
The sealed Release-F slice exited zero after 9m48s with no parked work.
Independent dashboard reads proved 72 complete FeatureSet projections with
3,456 rows, 72 complete 16-tile/262,144-cell waterfalls, and 72 Starlink v0.2
views containing 24 clipped `not_evaluated` and 48 candidate recordings, 768
streams and 6,144 method outputs. Candidate views retain both calibration-
required reason codes and every calibrated-detection count remains null.
Capture advanced from 396 to 413 during analysis and to 416 during the audit,
with 832/832 unique recordings and no halt.

The twelfth V5 online-analysis window (`396..431`) closed with exact digest
`5464dfcf2557f0be1282258bb6843904b8992c9accd2470909dfb92a34809bd7`.
The sealed Release-F slice exited zero after 10m01s with no parked work.
Independent dashboard reads proved 72 complete FeatureSet projections with
3,456 rows, 72 complete 16-tile/262,144-cell waterfalls, and 72 Starlink v0.2
views containing 24 clipped `not_evaluated` and 48 candidate recordings, 768
streams and 6,144 method outputs. Candidate views retain both calibration-
required reason codes and every calibrated-detection count remains null.
Capture advanced from 434 to 452 during analysis and to 455 during the audit,
with 910/910 unique recordings and no halt.

The thirteenth V5 online-analysis window (`432..467`) closed with exact digest
`ce658f5b9987e64363a31497fdbe0f6f92f3133f3c0ff8aa06cf912b7b2e0e7b`.
The sealed Release-F slice exited zero after 10m10s with no parked work.
Independent dashboard reads proved 72 complete FeatureSet projections with
3,456 rows, 72 complete 16-tile/262,144-cell waterfalls, and 72 Starlink v0.2
views containing 24 clipped `not_evaluated` and 48 candidate recordings, 768
streams and 6,144 method outputs. Candidate views retain both calibration-
...
The fifteenth V5 online-analysis window (`504..539`) closed with exact digest
`4128b3592e13a2f1e5f9d41a3406359d2fa16d52c26b18391496defb200d1c7f`.
The sealed Release-F slice exited zero after 10m24s with no parked work.
Independent dashboard reads proved 72 complete FeatureSet projections with
3,456 rows, 72 complete 16-tile/262,144-cell waterfalls, and 72 Starlink v0.2
views containing 24 clipped `not_evaluated` and 48 candidate recordings, 768
streams and 6,144 method outputs. Candidate views retain both calibration-
required reason codes and every calibrated-detection count remains null.
Capture advanced from 540 to 558 during analysis and to 561 during the audit,
with 1,122/1,122 unique recordings and no halt.
