...
| 3 | Database promoted | migration receipts exactly match approved files through `0037_focused_analysis_during_capture.sql`; initial drain and registered-terminal concurrent-analysis gates are true |
