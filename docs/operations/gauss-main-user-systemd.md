...
| 3 | Database promoted | migration receipts exactly match approved files through `0038_dashboard_surrogate_score_distributions.sql`; initial drain and registered-terminal concurrent-analysis gates are true |
