...
| 3 | Database promoted | migration receipts exactly match approved files through `0036_starlink_pilot_constellation_catalog.sql`; initial drain and registered-terminal concurrent-analysis gates are true |
