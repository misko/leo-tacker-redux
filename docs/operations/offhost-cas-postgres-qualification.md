...
name and SHA-256 receipt through `0037_focused_analysis_during_capture.sql`
...
| Required migration head (`0037_focused_analysis_during_capture.sql`) | Release manifest | Yes |
