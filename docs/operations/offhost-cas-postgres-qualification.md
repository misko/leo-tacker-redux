...
name and SHA-256 receipt through `0036_starlink_pilot_constellation_catalog.sql`
...
| Required migration head (`0036_starlink_pilot_constellation_catalog.sql`) | Release manifest | Yes |
