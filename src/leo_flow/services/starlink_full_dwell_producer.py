...
class FullDwellWorkRepositoryV0_1(Protocol):
    def admit(self, *, maximum_new: int, maximum_active: int) -> FullDwellAdmissionResultV0_1: ...

    def claim(self, worker_id: str, lease_ttl_s: float) -> FullDwellWorkLeaseV0_1 | None: ...

    def complete(self, lease: FullDwellWorkLeaseV0_1, result: ArtifactRef) -> None: ...

    def retry(self, lease: FullDwellWorkLeaseV0_1, reason: str, retry_at_utc_ns: UtcNs) -> None: ...
