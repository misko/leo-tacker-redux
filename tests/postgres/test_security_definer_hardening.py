...
DEFINER_FUNCTIONS = {
    ...
    "claim_starlink_adaptive_response_work_v0_1",
    "claim_starlink_pilot_refinement_work_v0_1",
    "claim_starlink_full_dwell_work_v0_1",
    ...
    "dispatch_full_dwell_refinement_v0_1",
    "enqueue_starlink_pilot_refinement_work_v0_1",
    "fail_full_dwell_refinement_dispatch_v0_1",
    "list_full_dwell_timeline_candidates_v0_1",
    "park_starlink_full_dwell_work_v0_1",
    "publish_recording_full_dwell_timeline_v0_1",
    "publish_recording_starlink_acquired_constellation_v0_3",
    "publish_recording_starlink_adaptive_qam_v0_4",
    "publish_recording_starlink_adaptive_response_v0_1",
    ...
    "publish_dashboard_capture_qam_summary_receipt_v0_2",
    "read_pending_dashboard_capture_qam_products_v0_1",
    "read_pending_dashboard_capture_qam_products_v0_2",
    "read_exact_dashboard_capture_qam_summary_receipt_v0_2",
    ...
    "read_exact_recording_starlink_adaptive_response_v0_1",
    "read_exact_recording_starlink_pilot_refinement_v0_1",
    "read_exact_recording_starlink_pilot_prescreen_v0_1",
    "read_exact_recording_starlink_full_dwell_v0_1",
    "read_full_dwell_timeline_hardware_v0_1",
    "read_latest_recording_full_dwell_timeline_v0_1",
    "read_latest_recording_starlink_acquired_constellation_v0_3",
    "read_latest_recording_starlink_adaptive_qam_v0_4",
    "read_latest_recording_starlink_adaptive_response_v0_1",
    "read_latest_recording_starlink_pilot_refinement_v0_1",
    ...
    "read_dashboard_capture_qam_snapshot_v0_1",
    ...
    "retry_starlink_pilot_refinement_work_v0_1",
    ...
    "capture_registered_analysis_safe_v3",
    ...
    "read_recording_starlink_temporal_pilot",
    "read_latest_recording_starlink_temporal_pilot",
    ...
    "register_focused_analysis_pair_scope_v1",
